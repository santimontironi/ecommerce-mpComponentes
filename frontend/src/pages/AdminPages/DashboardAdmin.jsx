...
const DashboardAdmin = () => {
  ...
  return (
    <section className="relative w-full h-screen py-12 xl:pt-14 xl:pb-10 overflow-hidden bg-linear-120 from-[#101010] to-[#001b48] flex justify-center items-center containerDashboard">
