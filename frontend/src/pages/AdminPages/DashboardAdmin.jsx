...
const DashboardAdmin = () => {
  ...
  return (
    <section className="relative w-full min-h-screen py-12 xl:py-14 overflow-x-hidden bg-linear-120 from-[#101010] to-[#001b48] flex justify-center items-center containerDashboard">
